 ...
 */
const SizeSettings = () => {
  const sizeSettings = useAppStore((state) => state.sizeSettings);
  const selectedCategories = useAppStore((state) => state.selectedCategories);
  const categoryStartValues = useAppStore((state) => state.categoryStartValues);
  const mode = useAppStore((state) => state.mode);
  const setSizeSettings = useAppStore((state) => state.setSizeSettings);
  const setCategoryStartValues = useAppStore(
    (state) => state.setCategoryStartValues
  );
  ...
  const handleStartValueBlur = (categoryId) => {
    ...
    if (savedValue === '') {
      ...
      setCategoryStartValues(newStartValues);
    }
  };
  ...
  const updateCategoryStartValue = useCallback(
    ...
    [categoryStartValues, setCategoryStartValues]
  );
